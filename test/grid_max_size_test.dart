...
void main() {
  ...
  group('Maximum Size Constraints', () {
    testWidgets('Module should not be resized larger than maxW (right handle)', (tester) async {
    ...
    testWidgets('Module should not be resized larger than maxH (bottom handle)', (tester) async {
      ZeusModule? updatedModule;
