...
void main() {
  ...
  group('Minimum Size Constraints', () {
    testWidgets('Module should not be resized smaller than minW (right handle)', (tester) async {
      ZeusModule? updatedModule;
      final module = ZeusModule(id: 'm1', x: 0, y: 0, w: 20, h: 20, minW: 5, minH: 5);
      ...
      final centerOfModule = tester.getCenter(find.byKey(const Key('content_m1')));
      ...
      final dragGesture = await tester.startGesture(rightEdge, kind: PointerDeviceKind.mouse);
      await tester.pump();
    ...
    testWidgets('Module should not be resized smaller than minH (bottom handle)', (tester) async {
      ZeusModule? updatedModule;
      final module = ZeusModule(id: 'm1', x: 0, y: 0, w: 20, h: 20, minW: 5, minH: 5);
      ...
      final dragGesture = await tester.startGesture(bottomEdge, kind: PointerDeviceKind.mouse);
      await tester.pump();
    ...
    testWidgets('Module should not be resized smaller than minW/minH (topLeft handle)', (tester) async {
      ZeusModule? updatedModule;
      final module = ZeusModule(id: 'm1', x: 10, y: 10, w: 20, h: 20, minW: 5, minH: 5);
      ...
      final dragGesture = await tester.startGesture(topLeftCorner, kind: PointerDeviceKind.mouse);
      await tester.pump();
