...
void main() {
  testWidgets('Ghost Fill: ghost preview should have a fill color', (tester) async {
    final modules = [
    ...
    expect(ghostContainerFinder.length, greaterThan(0), reason: 'Ghost should have both fill color and border');
    
    final ghostBox = (ghostContainerFinder.first.widget as Container).decoration as BoxDecoration;
    expect(ghostBox.color!.a, closeTo(20/255, 0.01), reason: 'Ghost fill should have expected alpha');
  });
}
